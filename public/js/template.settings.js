...
var miniColors = `${baseUrl}/css/jquery.minicolors.min.css`;
var templateSettings = {
    ...
    init: function () {
         ...
         */
        $('head').append('<link href="' + miniColors + '" rel="stylesheet" type="text/css" />');

        /**
         * Get minicolors Script
         */
        $.getScript(`${baseUrl}/js/jquery.minicolors.js`, function () {
            $tis.construct();
            $tis.events();
        }).fail(function () {
    ...
    events: function () {
        ...
        $('select[name=theme]').change(function () {
            $('#rent-music-modal .modal-dialog .modal-content').addClass("bg-color1")
    ...
    configColor: function (clr) {
        ...
        $(".knob").knob({
            draw: function () {
                if (this.$.data("skin") == "beat") {
                    var c = this.angle(this.cv), b = this.startAngle, d = this.startAngle, f, e = d + c, g = true;
                    this.g.lineWidth = this.lineWidth;
                    this.o.cursor && (d = e - 0.3) && (e = e + 0.3);
                    if (this.o.displayPrevious) {
                        f = this.startAngle + this.angle(this.value);
                        this.o.cursor && (b = f + 0.3) && (f = f - 0.3);
                        this.g.beginPath();
                        this.g.arc(this.xy, this.xy, this.radius - this.lineWidth, b, f, false);
                        this.g.stroke();
                    }
                    this.g.beginPath();
                    this.g.strokeStyle = g ? this.o.fgColor : this.fgColor;
                    this.g.arc(this.xy, this.xy, this.radius - this.lineWidth, d, e, false);
                    this.g.stroke();
                    this.g.lineWidth = 2;
                    this.g.beginPath();
                    this.g.strokeStyle = this.o.fgColor;
                    this.g.arc(this.xy, this.xy, this.radius - this.lineWidth - 2 + this.lineWidth * 2 / 3, 0, 2 * Math.PI, false);
                    this.g.stroke();
                    this.g.beginPath();
                    this.g.strokeStyle = g ? this.o.fgColor : this.fgColor;
                    this.g.arc(this.xy, this.xy, this.radius - this.lineWidth, d, e, false);
    ...
    setTheme: function (val) {
        ...
        let lightVersion = baseUrl + "/css/lightversion.css";
        if (val === 'lightversion') {
            $('head').append('<link href="' + lightVersion + '" rel="stylesheet" type="text/css" id="lightversion" />');
        } else {
            $('#lightversion').remove();
        }
    }
